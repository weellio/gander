...
- Adds a **🚀 Gander** status-bar button and a **"Gander: Open Dashboard (full tab)"** command, which
...
3. In that window, click **🚀 Gander** in the status bar (or run **"Gander: Open Dashboard (full tab)"** from the Command Palette).
