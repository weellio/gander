...
- **Slack alerts** — paste an incoming-webhook URL (api.slack.com/apps → Incoming Webhooks) and every alert Telegram gets is mirrored to a Slack channel. Outbound only; two-way control stays on Telegram.
